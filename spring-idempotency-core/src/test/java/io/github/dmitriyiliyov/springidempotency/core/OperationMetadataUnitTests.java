...
public class OperationMetadataUnitTests {
    ...
    private static class TestFingerprintPolicy implements FingerprintPolicy {
        ...
        @Override
        public String generate(io.github.dmitriyiliyov.springidempotency.core.RequestContext context) {
            return "fingerprint";
        }
        ...
        @Override
        public void handle(io.github.dmitriyiliyov.springidempotency.core.fingerprint.FingerprintMismatchContext context) {
        }
    }
}